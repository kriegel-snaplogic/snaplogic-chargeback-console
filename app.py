...
_DEMO_SERVER = os.getenv("SNAPLOGIC_SERVER", "https://elastic.snaplogic.com")
_DEMO_ORG    = os.getenv("SNAPLOGIC_ORG", "DemoOrg")
...
with st.expander("🔌 Platform Environments", expanded=not has_envs and not st.session_state.get("_auto_connect_tried")):
    ...
    if pf1.button("⚡ Pre-fill DemoOrg (EMEA)"):
        st.session_state["_new_env_name"]   = "DemoOrg"
        st.session_state["_new_env_server"] = _DEMO_SERVER
        st.session_state["_new_env_org"]    = "DemoOrg"
        st.rerun()
    ...
    with st.form("add_env_form"):
        ...
        env_server = fc2.text_input("Server URL",
                                    ...
                                    placeholder="https://elastic.snaplogic.com")
